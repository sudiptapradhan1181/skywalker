...
export const RESUME_LINK =
  'https://drive.google.com/file/d/1Vq3ovNSnkMf5Ya5wUhpqAfX03ZfGnjeY/view?usp=sharing';
...
export const EXPERIENCE_TABS = [
  {
    ...
    details: [
      'Piloted the end-to-end development of an employer-focused Progressive Web App (PWA) for onboarding, business verification, job posting, and application tracking. Achieved 4000+ onboarded employers with 1000+ recruiters hiring through the system',
